"""
utils/languages.py
Daftar kode bahasa ISO 639-1 (2 huruf) beserta nama bahasa dalam Bahasa
Inggris, dipakai untuk menu pilihan bahasa (menu utama -> 🌐 Bahasa).

Catatan jujur: menu ini MENYIMPAN pilihan bahasa setiap user secara
permanen (lihat utils/settings.get_user_language / set_user_language),
dan itu berlaku untuk SEMUA ~180 bahasa di bawah. Tapi menerjemahkan
seluruh teks UI bot ke 180 bahasa secara akurat bukan hal yang realistis
untuk dikerjakan sekaligus di sini — lihat utils/translations.py untuk
daftar bahasa yang sudah punya teks konfirmasi terjemahan, dan bagaimana
menambah bahasa baru ke sana.
"""
